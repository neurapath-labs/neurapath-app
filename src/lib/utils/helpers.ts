...
export function deltaToRawText(delta: any): string {
  // This is a simplified version - in a real implementation, you would use Quill's
  // functionality to convert Delta to plain text
