...
>
	...
	<nav id="quick-actions" class="flex flex-col gap-1 text-sm">
		...
		<button
			type="button"
			class="action relative flex items-center gap-2 rounded px-2 py-1 hover:bg-[rgba(var(--background-color),0.12)] hover:shadow-[inset_3px_0_0_0_rgb(var(--background-color_button))] active:bg-[rgba(var(--background-color),0.14)] cursor-pointer"
			onclick={toggleTheme}
		>
			<SunIcon
