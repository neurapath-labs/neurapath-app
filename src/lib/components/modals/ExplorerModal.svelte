...
{#if isOpen}
  <div class="visible modalbox" id="modalbox-explorer">
    <div class="modalbox-header">
      <img class="modalbox-icon" src="/img/find.svg" alt="Explorer icon">
      <span class="modalbox-title">Item Explorer</span>
    </div>
    <table id="explorer-list">
      <thead>
        <tr>
          <th>Name</th>
          <th>Repetitions</th>
    ...
    <button class="modalbox-button" on:click={closeExplorer} type="button">Close</button>
  </div>
{/if}
